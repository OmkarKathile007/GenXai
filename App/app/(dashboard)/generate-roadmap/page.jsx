...
const GenAI = () => {
    ...
    const fetchSavedRoadmaps = async () => {
        try {
            ...
            const { data } = await axios.get(`${BACKEND_URL}/api/roadmaps/my-roadmaps`, {
    ...
    const saveToDatabase = async (aiData, userQuestion) => {
        try {
            ...
            const { data } = await axios.post(`${BACKEND_URL}/api/roadmaps/save`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const updateDatabase = async (updatedSchedule) => {
        ...
        try {
            ...
            await axios.put(`${BACKEND_URL}/api/roadmaps/${currentRoadmapId}`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const generateSchedule = async () => {
        ...
        try {
            const { data } = await axios.post(`${BACKEND_URL}/api/ai/roadmap`, 
                { question: question }, 
                        ...
                        <div className="bg-slate-900/80 backdrop-blur-md border border-slate-700 p-4 rounded-xl shadow-2xl max-w-xs w-64">
                            ...
                            <div className="max-h-48 overflow-y-auto custom-scrollbar flex flex-col gap-1 pr-2">
                                {savedRoadmaps.map((rm) => (
                                    ...
                                    >
                                        <span className="block font-semibold truncate text-slate-200 group-hover:text-sky-300">{rm.title}</span>
                    ...
                    <div className="w-full flex flex-col items-center justify-center min-h-screen z-10 relative px-4">
                        ...
                        >
                            ...
                            <p className="text-lg text-slate-400 mb-8 max-w-xl mx-auto">
                                Define your goal. We'll generate a high-impact week of deep work. 
                                You manage the tasks.
                            </p>
                    ...
                    <div className="w-full pt-16 px-4 md:px-8 max-w-[1600px] mx-auto z-10 relative">
                        <div className="flex justify-between items-end mb-8 border-b border-slate-800 pb-4">
                            <div>
                                ...
                                <p className="text-slate-400 text-sm mt-1">
                                    Generated for: <span className="text-sky-300">"{question}"</span>
                                </p>
                            </div>
                            <button 
                                onClick={() => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-hand text-center">Sprint Complete!</h3>
                                <p className="text-sm text-center mt-2 opacity-60">Review your progress and plan the next one.</p>
                            </motion.div>
                        </div>
                    </div>
                )}
